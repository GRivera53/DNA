...
import { List, Button, Icon, Modal, notification, Timeline } from "antd";
...
export default function PostsList(props) {
  ...
  return (
    <div className="posts-list">
      ...
      />
      <Timeline>
        <Timeline.Item>Reporte 1 2015-09-01</Timeline.Item>
        <Timeline.Item>Reporte 2 2015-09-01</Timeline.Item>
        <Timeline.Item>Reporte 3 2015-09-01</Timeline.Item>
